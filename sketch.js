...
var food;
var rabbit;
var star, star2, emptyStar, halfEmpty, twoStar, starImage, starScore;
...
function preload()
{
  ...
  halfEmpty = loadAnimation("one_star.png");
  twoStar = loadAnimation("stars.png");
  starImage = loadAnimation("star.png");
...
function setup() 
{
  ...
  starScore = createSprite(75, 35);
  starScore.addAnimation('empty', emptyStar);
  starScore.addAnimation('half-empty', halfEmpty);
  starScore.addAnimation('filled', twoStar);
  starScore.changeAnimation('empty');
  starScore.scale = 0.2;
  
  star = createSprite(280, 100);
  star.addAnimation('starcheck',starImage);
  star.scale = 0.02;

  star2 = createSprite(50, 350);
  star2.addAnimation('starcheck2', starImage);
  star2.scale = 0.02;
...
if(collide(fruit,star,20)==true)
  {
    star.visible = false;
    starScore.changeAnimation('half-empty');
  }

if(collide(fruit,star2,20)==true)
  {
    star2.visible = false;
    starScore.changeAnimation('filled');
  }
